...
const (
	...
	withingsAPIBaseEU     = "https://wbsapi.withings.net"
	withingsAPIBaseUS     = "https://wbsapi.us.withingsmed.net"
...
func apiBaseURL(baseOverride, cloud string) string {
	if baseOverride != emptyString {
		return strings.TrimRight(baseOverride, "/")
	}

	if cloud == "us" {
		return withingsAPIBaseUS
	}

	return withingsAPIBaseEU
}
